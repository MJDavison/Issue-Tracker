    ...
    public partial class AddedChildrenforTicketandProjectUser : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProjectUser", x => new { x.PersonnelId, x.ProjectId });
                    table.ForeignKey(
                        name: "FK_ProjectUser_Users_PersonnelId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TicketUser", x => new { x.PersonnelId, x.TicketId });
                    table.ForeignKey(
                        name: "FK_TicketUser_Users_PersonnelId",
                        column: x => x.PersonnelId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
